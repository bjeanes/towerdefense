...
module Juggernaut
  ...
  class << self
    ...
    def client_in_channel?(client, channel)
      clients = show_clients_for_channel(channel)
      !clients.find{|c| c['id'] == client}.nil?
    end
        ...
        def render_for_juggernaut(data, options = {})
          ...
          case options[:type]
            ...
            when :send_to_client_on_channels:
              ...
              Juggernaut.send_to_client_on_channel(data, options[:client_id], options[:channels])
